                    ...
                    <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in-95">
                        ...
                        <div className="p-8 flex flex-col gap-4">
                            ...
                            <div className="flex gap-3 mt-4">
                                ...
                                <button type="button" onClick={handleSaveActionPlan} className="flex-1 py-3 bg-emerald-600 text-white font-black uppercase text-xs rounded-xl shadow-lg hover:bg-emerald-700 transition-all">Save Action</button>
                            </div>
                        </div>
                    </div>
                </div>
