    ...
    <div className="flex flex-col gap-6 animate-in fade-in duration-300">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 print:hidden">
            ...
            <div className="flex gap-2">
                ...
                <button onClick={() => navigate('/report-isolation')} className="h-10 w-44 bg-indigo-600 text-white rounded-lg font-black uppercase tracking-widest shadow hover:bg-indigo-700 flex items-center justify-center gap-2 transition-all text-[10px]"><PlusCircle size={14} /> Register Admit</button>
            </div>
        </div>
        ...
        <div className="bg-white px-4 py-3 rounded-xl shadow-sm border border-gray-200 print:hidden overflow-x-auto">
            <div className="flex items-center gap-3 min-w-max">
                ...
                <button onClick={() => { setFilterArea(''); setSelectedMonth(''); setSelectedQuarter(''); setSearchQuery(''); }} className="p-1.5 text-slate-400 hover:text-indigo-600 transition-all"><RotateCcw size={14} /></button>
            </div>
        </div>
